...
class ReceptionistModule:
    ...
    def __init__(self, config):
        ...
        self.greeting = config.get(
            ...
            f"Thank you for calling {config.company_name}. This is Velma, how may I help you today?"
        )
    ...
    async def process(
        ...
        system_prompt = f"""You are Velma, the receptionist for {self.config.company_name}, an NDIS service provider.
