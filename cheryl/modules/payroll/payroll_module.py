...
Cheryl automatically checks for:
- Overlapping shifts
...
**Cheryl Auto-Calculation:**
Cheryl automatically:
...
**STP Software:**
Cheryl integrates with STP-enabled payroll systems:
- Employment Hero
- Xero Payroll
- MYOB
- KeyPay
...
**Important:** STP submissions are legal declarations. While Cheryl automates
