...
**Automatic Reminders:**
Cheryl automatically sends reminders when credentials are approaching expiry.
...
Cheryl automatically monitors the following credentials and sends reminders:
