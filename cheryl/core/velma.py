...
class Cheryl:
    ...
    def __init__(self, config: Config):
        """
        Initialize Cheryl with configuration
        ...
        logger.info("Cheryl initialized successfully")
    ...
    async def _classify_intent(
        ...
        """
        system_prompt = """You are Cheryl, an AI assistant for an NDIS company.
    ...
    async def _handle_general_query(
        ...
        system_prompt = f"""You are Cheryl, a helpful AI assistant for {self.config.company_name},
